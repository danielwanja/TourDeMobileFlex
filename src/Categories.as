package
{
	...
	public class Categories
	{
		...
		public static const dataEntry:SampleCategory = new SampleCategory(2000001, "Data Entry Controls", SampleListView, Icons.viewForm, new ArrayList([Samples.textInput, Samples.textArea, Samples.radioButtons, Samples.checkbox, Samples.toggleSwitch, Samples.slider, Samples.spinnerList]));
		...
		public static const allSamples:SampleCategory = new SampleCategory(2300000, "All Samples", SampleListView, Icons.headerLogo, 
			new ArrayList([Samples.mobileAppAnatomy, Samples.scrollableView, Samples.busyIndicator,
				...
				Samples.textInput, Samples.textArea, Samples.radioButtons, Samples.checkbox, Samples.slider, Samples.toggleSwitch, Samples.spinnerList,
